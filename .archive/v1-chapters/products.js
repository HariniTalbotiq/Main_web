...
/* ---- SERVICES ------------------------------------------------------------
   The engagements, as opposed to the products: what TalbotIQ does FOR you
   rather than what it sells you a seat in. Names, one-line summaries and URLs
   are verbatim from the live talbotiq.com mega menu (the site labels the group
   "Solutions"; the URLs and the header here say "Services"). Summaries are
   trimmed to one clause each — the site's own sentences run long enough to
   swamp a menu row, and a menu is a signpost, not the page. */
const SERVICES = [
  {
  ...
  {
    name: 'AI Agents & Bots Development',
  ...
  {
    name: 'Full Stack Development & AI Integration',
...
const SERVICES_INDEX = 'https://talbotiq.com/services/';

/* ---- INDUSTRIES ----------------------------------------------------------
   The five sectors named on the talbotiq.com homepage, in that order.

   THEY ARE DELIBERATELY NOT LINKS. There are no per-sector pages yet
   (talbotiq.com/industries/ is a 404), and five menu rows pointing at one
   generic destination is the kind of thing this page has a rule against. So
   the panel states the five sectors and offers the one real next step —
   telling us which one you are. Give a sector a `url` and it becomes a link
   on the next build; nothing else needs to change. */
const INDUSTRIES = [
  { name: 'Healthcare',                url: null },
  { name: 'Retail & Commerce',         url: null },
  { name: 'Finance',                   url: null },
  { name: 'Supply Chain & Logistics',  url: null },
  { name: 'Food & Beverage',           url: null },
];
...
module.exports = { COMPANY, SERVICES, SERVICES_INDEX, INDUSTRIES, CATEGORIES, PRODUCTS, LIFECYCLE };
